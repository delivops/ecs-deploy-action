    ...
    if secret_files:
        ...
        init_container = {
            ...
            "command": [
                ...
                "# First try to get as SecretString (for text secrets)"
                ...
                "# Try to get as SecretBinary (for binary secrets like certificates/keys)"
                ...
                "BINARY_RESULT=$?; "
                "if [ $BINARY_RESULT -eq 0 ] && [ -s {secrets_files_path}/$secret ]; then "
